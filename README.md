...
- **Personalization** — two looks (the classic design, and "Apple Horror": glass over a living aurora sky), three themes + accent colors that follow the profile to every device, custom avatar photos, a taste picker, an ambient screensaver, and **Aurora Wrapped** (your stats, all year round, with roasts)
