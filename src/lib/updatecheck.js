// Read-only update check: is there a commit on GitHub master that this
// server doesn't have? NEVER pulls, never writes — it only reports. Fails
// silent when offline (the pill just doesn't show).
//
...
module.exports = { check, _internals: { git, isAncestor } };
